<template>
    <div class="main-content">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            <el-button
                                    ...
                                    @click="pandianHandler(scope.row.id)">库存盘点
                            </el-button>
                        </template>
                    </el-table-column>
                </el-table>
        ...
        <pandian v-if="pandianFlag" :parent="this" ref="pandian"></pandian>
    </div>
</template>
<script>
    import pandian from "./pandian";
    ...
    export default {
        ...
        methods: {
            ...
            // 盘点
            pandianHandler(id, type) {
                this.showFlag = false;
                this.pandianFlag = true;
                this.$nextTick(() => {
                    this.$refs.pandian.init(id);
                });
            },
            // 查看评论
            // 下载
