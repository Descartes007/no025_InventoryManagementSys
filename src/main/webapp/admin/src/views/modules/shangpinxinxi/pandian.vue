    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" label="损坏数量" prop="shangpinshuliang">
                        <el-input v-model="ruleForm.shangpinshuliang"
                                  placeholder="损坏数量"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" label="损坏描述" prop="shangpinshuliang">
                        <el-input v-model="ruleForm.miaoshu" type="textarea" :rows="3"
                                  placeholder="损坏描述"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.ruleForm.shangpinshuliang = ''
                    } else {
