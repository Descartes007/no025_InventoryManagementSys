    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangpintupian" label="商品图片"
                                  prop="shangpintupian">
                        <file-upload
                                tip="点击上传商品图片"
                                action="file/upload"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpintupian" label="商品图片" prop="shangpintupian">
                            <img style="margin-right:20px;" v-bind:key="index"
                                 v-for="(item,index) in ruleForm.shangpintupian.split(',')" :src="item" width="100"
                                 height="100">
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'" label="商品编号" prop="bianhao">
                        <el-input v-model="ruleForm.bianhao"
                                  placeholder="商品编号" clearable :readonly="ro.bianhao"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="商品编号" prop="bianhao">
                            <el-input v-model="ruleForm.bianhao"
